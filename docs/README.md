...
| [plan-modes-de-reservation.md](plan-modes-de-reservation.md) | Plan de conception des modes de réservation par produit (créneau fixe / flexible à l'heure / demi-journée / journée) : modèle de données, architecture par stratégies, phases de livraison. |
